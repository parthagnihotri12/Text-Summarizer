  ...
  return (
    <div className="bg-white h-screen w-screen overflow-x-hidden">
      <nav className="h-24 bg-purple-600 ">
        <h1 className="text-4xl text-white text-center py-6">
        Simplify the Complex:A Summarizer's Hub
        </h1>
      </nav>

      <p className="p-4 f text-xl text-center mt-8">
        Welcome to the Simplify the Complex:A Summarizer's Hub This app leverages the power of Artificial Intelligence APIs to provide concise summaries of long texts.
      </p>
      <p className="p-4 f text-xl text-center mt-12">
        ...
        <div className="w-4/5 flex  m-5 mt-10 ">
          <div className="bg-gray-50 h-full w-1/2 mr-5 rounded border-2 border-black">
            <textarea
              ...
              placeholder="Enter the text here minimum 200 characters"
              onChange={changing}
              value={text}
            />
      ...
      <div className="flex justify-center">
        {!loading ? (
          <>
            <button
              className="bg-orange-400 hover:bg-orange-600 hover:text-white h-12 w-40 font-bold text-xl mb-5 rounded-lg"
              onClick={summarizing}
            >
              Summarize
            </button>
            <button
              className="bg-purple-400 hover:bg-purple-700 hover:text-white h-12 w-40 font-bold text-xl mb-5 ml-4 rounded-lg"
              onClick={clear}
            >
              Clear
            </button>
      ...
      <section className="h-80 bg-green-50">
        <div className="flex justify-center">
          <div className="text-center mt-12">
            ...
            <p className="text-2xl">Join with me to elevate your software development and API knowledge.</p> */}
            <p className="text-2xl">Let's get connected</p>
            <div className="flex justify-center p-5 ">
              {/* <img
                src="https://cdn-icons-png.flaticon.com/128/15015/15015975.png"
                className="h-16 m-5 cursor-pointer"
                onClick={() =>
                  window.open("https://www.linkedin.com/in/imranpasha636/")
                }
              /> */}
              <img
